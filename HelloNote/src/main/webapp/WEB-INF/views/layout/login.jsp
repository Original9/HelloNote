...
<body>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form id= "user" name="user" class="user" action="processLogin" method="POST">
	...
	<div id="webcam-container" align='center' style="position:relative; top:-360px; left:-240px;">
	</div>
...
<script type="text/javascript">
    ...
    async function predict() {
        ...
        if(prediction[1].className =="admin" && prediction[1].probability.toFixed(2) > 0.9){
