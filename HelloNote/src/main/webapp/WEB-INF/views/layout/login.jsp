...
<head>
    ...
    <link href="resources/assets/css/mainFont.css" rel="stylesheet" type="text/css">
</head>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;resources/assets/img/dogs/image3.jpeg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="processLogin" method="POST">
                                        ...
                                        <hr><a class="btn btn-primary btn-block text-white btn-google btn-user" role="button">&nbsp; Login with Google</a><a class="btn btn-primary btn-block text-white btn-facebook btn-user" role="button">&nbsp; Login with Facebook</a>
                                        <hr>
                                    </form>
